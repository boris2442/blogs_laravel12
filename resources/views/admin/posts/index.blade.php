...
<section class="py-8 px-4 sm:px-6 lg:px-8 bg-white dark:bg-[#111827] min-h-screen">
    <div class="sm:flex sm:items-center sm:justify-between mb-6">
        <div>
            <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Articles du blog</h1>
            <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">Gérez ici les publications du blog.</p>
        </div>
    ...
    <div class="overflow-x-auto rounded-lg shadow-sm ring-1 ring-gray-200 dark:ring-gray-700">
        <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
            <thead class="bg-gray-50 dark:bg-gray-800">
                <tr>
                    <th class="px-6 py-3 text-left text-sm font-semibold text-gray-900 dark:text-white">Titre</th>
