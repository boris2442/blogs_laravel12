...
<section>
    <div class="sm:flex sm:items-center">
        ...
        <div class="mt-4 sm:ml-16 sm:mt-0 sm:flex-none">
            <a href="{{ route('admin.posts.create') }}" class="inline-flex rounded-md dark:bg-green-600 px-3 py-2 text-center text-sm font-semibold dark:text-red-500 shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Créer un post</a>
        </div>
    </div>
                    ...
                    <tbody class="bg-white">
                        ...
                        <tr class="even:bg-gray-50">
                            ...
                            <td x-data class="relative whitespace-nowrap py-4 pl-3 pr-4 text-right text-sm font-medium sm:pr-3">
                                ...
                                <form method="post" action="{{ route('admin.posts.destroy', ['post' => $post]) }}" method="POST">
                                    @csrf
                                    @method('DELETE')
                                    <button
