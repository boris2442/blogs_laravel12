    ...
    <div {{-- class="p-6 lg:p-8" --}}>
        {{-- <header class="w-full lg:max-w-4xl max-w-[335px] text-sm mb-6 not-has-[nav]:hidden">
            ...
            <nav class="flex items-center justify-end gap-4">
                <a href="{{ route('about') }}"
                    class="inline-block px-5 py-1.5 dark:text-[#EDEDEC] border-[#19140035] hover:border-[#1915014a] border text-[#1b1b18]   rounded-sm text-sm leading-normal">
                    A propos
                </a>
                <a href="{{ route('posts.index') }}"
                    class="inline-block px-5 py-1.5 dark:text-[#EDEDEC] border-[#19140035]  border text-[#1b1b18]   rounded-sm text-sm leading-normal">
                    Blogs
                </a>
        ...
        {{-- <header class="w-full px-4 py-3 border-b dark:border-neutral-700">
            <div class="max-w-7xl mx-auto flex items-center justify-between">
                ...
                <nav class="hidden md:flex items-center gap-5 text-sm">
                    <a href="{{ url('/') }}"
                        class="hover:text-blue-600 dark:hover:text-blue-400 text-neutral-800 dark:text-neutral-200">
                        Accueil
                    </a>
                    <a href="{{ route('posts.index') }}"
                        class="hover:text-blue-600 dark:hover:text-blue-400 text-neutral-800 dark:text-neutral-200">
        ...
        <header x-data="{ open: false }" class="w-full px-4 py-3 border-b dark:border-neutral-700">
            <div class="max-w-7xl mx-auto flex items-center justify-between">
                ...
                <nav class="hidden md:flex items-center gap-6 text-sm">
                    {{-- <a href="{{ url('/') }}"
                        class="hover:text-blue-600 dark:hover:text-blue-400 text-neutral-800 dark:text-neutral-200">Accueil</a>
                    --}}

                    <a href="{{ route('about') }}"
                        class="hover:text-blue-600 dark:hover:text-blue-400 text-neutral-800 dark:text-neutral-200">À
                        propos
                    </a>
                    <a href="{{ route('posts.index') }}"
                        class="hover:text-blue-600 dark:hover:text-blue-400 text-neutral-800 dark:text-neutral-200">Blog</a>
                    <a href="{{ route('contact') }}"
                        class="hover:text-blue-600 dark:hover:text-blue-400 text-neutral-800 dark:text-neutral-200">Contact</a>

                    @auth
                    <a href="{{ url('/dashboard') }}"
                        class="hover:text-blue-600 dark:hover:text-blue-400 text-neutral-800 dark:text-neutral-200">Dashboard</a>
                    @else
                    <a href="{{ route('login') }}"
                        class="hover:text-blue-600 dark:hover:text-blue-400 text-neutral-800 dark:text-neutral-200">Connexion</a>
                    @if (Route::has('register'))
                    <a href="{{ route('register') }}"
                        class="hover:text-blue-600 dark:hover:text-blue-400 text-neutral-800 dark:text-neutral-200">S'inscrire</a>
                    @endif
                    @endauth
                </nav>
                ...
                <button @click="open = !open" class="md:hidden focus:outline-none">
                    <svg class="w-6 h-6 text-neutral-800 dark:text-white" fill="none" stroke="currentColor"
                        viewBox="0 0 24 24">
                        <path :class="{'hidden': open, 'inline-flex': !open }" stroke-linecap="round"
                            stroke-linejoin="round" stroke-width="2" d="M4 6h16M4 12h16M4 18h16" />
                        <path :class="{'inline-flex': open, 'hidden': !open }" stroke-linecap="round"
            ...
            <div x-show="open" class="md:hidden mt-3 px-2 space-y-2">
                <a href="{{ url('/') }}"
                    class="block px-4 py-2 text-sm text-neutral-800 dark:text-neutral-200 hover:bg-gray-100 dark:hover:bg-gray-700">Accueil</a>
                <a href="{{ route('posts.index') }}"
                    class="block px-4 py-2 text-sm text-neutral-800 dark:text-neutral-200 hover:bg-gray-100 dark:hover:bg-gray-700">Blog</a>
                <a href="{{ route('about') }}"
                    class="block px-4 py-2 text-sm text-neutral-800 dark:text-neutral-200 hover:bg-gray-100 dark:hover:bg-gray-700">À
                    propos</a>
                <a href="{{ route('contact') }}"
                    class="block px-4 py-2 text-sm text-neutral-800 dark:text-neutral-200 hover:bg-gray-100 dark:hover:bg-gray-700">Contact</a>

                @auth
                <a href="{{ url('/dashboard') }}"
                    class="block px-4 py-2 text-sm text-neutral-800 dark:text-neutral-200 hover:bg-gray-100 dark:hover:bg-gray-700">Dashboard</a>
                @else
                <a href="{{ route('login') }}"
                    class="block px-4 py-2 text-sm text-neutral-800 dark:text-neutral-200 hover:bg-gray-100 dark:hover:bg-gray-700">Connexion</a>
                @if (Route::has('register'))
                <a href="{{ route('register') }}"
                    class="block px-4 py-2 text-sm text-neutral-800 dark:text-neutral-200 hover:bg-gray-100 dark:hover:bg-gray-700">S’inscrire</a>
                @endif
                @endauth
            </div>
        </header>
        ...
        {{-- <div --}} {{--
            ...
            <main class="w-[100vw]">
                <section
                    class="home-page  text-white min-h-[70vh]  px-3  w-full  md:px-8 lg:px-16 xl:px-24 flex flex-col md:flex-row py-2 ">
                    <div class="py-8 md:py-16 lg:py-24 flex-1 flex flex-col justify-center items-start">
                        <h1 class="text-3xl md:text-5xl font-extrabold mb-4 leading-tight">
                            Boris <span class="text-blue-400">Tech</span><br>
                            <span class="text-xl md:text-2xl font-medium text-gray-300">La technologie entre vos
                                mains.</span>
                        </h1>
                        ...
                        <div>
                            <a href="{{ route('about') }}"
                                class="inline-block bg-blue-600 hover:bg-blue-700 text-white font-semibold px-4 py-2 rounded-lg shadow-md transition duration-300">
                                En savoir plus
                            </a>
                        </div>
                    </div>
